...
<head>
    ...
    <meta property="og:image" content="{{ asset('images/icon-192x192.png') }}">
    ...
    @yield('schema')
    <!-- Schema end -->
    <link rel="preload" href="/images/calculator-pencil.webp" as="image" type="image/webp">
    <link rel="preload" href="/images/dark_tint.webp" as="image" type="image/webp">
</head>
