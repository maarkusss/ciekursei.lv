    ...
    <div class="w-full p-4 bg-white rounded">
        <div class="flex items-center justify-end w-full">
            <form>
                <label>
                    <input
                        class="px-3 py-2 text-gray-700 bg-white border-gray-300 rounded-lg focus:border-primary-dark focus:ring-primary-dark"
                        ...
                        <tr class="bg-blue-100 border-b hover:bg-blue-200">
                            ...
                            <td class="p-2 text-center">
                                @if ($visitor->country !== 'ZZ')
                                    <a href="#" onclick="prompt('IP','{{ $visitor->ip }}');return false;">
