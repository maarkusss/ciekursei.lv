                ...
                <div class="grid gap-2.5 bg-white rounded-md">
                    ...
                    <div class="max-w-full prose prose-p:text-gray-600">
                        <div class="flex items-center justify-center">
                            <img class="object-contain max-w-full max-h-96 rounded-xl" src="{{ $blogPost->image }}"
                                alt="{{ $blogPost->image_alt_text }}" loading="lazy"
                    ...
                    <div class="flex items-center justify-between py-4 mb-4">
                        <div class="pl-4">
                            <button
                                class="p-1 mx-1 text-white transition-all duration-200 rounded-full bg-primary-normal hover:bg-primary-dark hover:shadow-lg"
                                type="button" onclick="shareFacebook('{{ request()->url() }}');">
                            ...
                            <button
                                class="p-1 mx-1 text-white transition-all duration-200 rounded-full bg-primary-normal hover:bg-primary-dark hover:shadow-lg"
                                type="button" onclick="shareTwitter('{{ request()->url() }}', '{{ $blogPost->name }}');">
                                <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                                    <path
                        ...
                        <div>
                            <span
                                class="pb-4 pr-4 text-sm text-right text-gray-500 group-hover:text-primary-dark group-hover:underline">
